  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <p className="verdana text-[#6C5644] mt-1">
      ...
      <section className="space-y-3">
        ...
        <div className="h-56 md:h-72 rounded-2xl bg-[#F1DECA] border border-black/10 shadow-inner grid place-items-center text-[#6C5644]">
